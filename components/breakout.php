	...
	<div class="container"> 
		...
		<div class="row">
			<div class="col-md-8">	
				...
				<a href="programs/breakout.jar">Nedladdningslänk:</a>
			</div>
			<div class="col-md-4">
				<center><a href="img/effectsLibrary3" target="_blank"><img src="img/effectsLibrary3" style="max-width: 350px; max-height: 400px; background-size: 100% 100%" class="img-rounded" alt=""></a></center>
			</div>
		</div>
	</div>
</body>
